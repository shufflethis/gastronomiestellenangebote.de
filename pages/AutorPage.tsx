  ...
  return (
    <div className="page-container autor-page">
      ...
      <section className="autor-detail">
        <h2>Thomas Sander</h2>
        <p className="autor-role">Gruender & Geschaeftsfuehrer von gastronomiestellenangebote.de</p>

        <div className="autor-content">
          <p>
            Thomas Sander gruendete gastronomiestellenangebote.de mit der Vision, den Recruiting-Prozess
            im Bereich Gastronomie grundlegend zu verbessern. Als erfahrener Experte im
          ...
          <p>
            ...
            von Arbeitgebern als auch von Fachkraeften im Gastronomie-Bereich.
          </p>

          <h3>Expertise</h3>
          <ul>
            <li>Gastronomie & Branchenkenntnisse</li>
            <li>Personalwesen & Recruiting</li>
            <li>Digitale Jobportale & HR-Tech</li>
            <li>Arbeitsmarktanalysen im Gastronomie-Bereich</li>
          </ul>
        </div>
      </section>
